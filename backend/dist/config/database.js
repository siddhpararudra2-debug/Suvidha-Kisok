...
// Session management
export async function setSession(userId, token, ttlSeconds = 900) {
    ...
    `);
        ...
        if (parseInt(adminCountResult.rows[0].count) === 0) {
            ...
            for (const admin of admins) {
                ...
                await pool.query(`INSERT INTO admin_users (employee_id, name, designation, department, role, password_hash, permissions, is_active)
                     VALUES ($1, $2, $3, $4, $5, $6, $7, true)`, [admin.employeeId, admin.name, admin.designation, admin.department, admin.role, hash, JSON.stringify(admin.permissions)]);
            }
